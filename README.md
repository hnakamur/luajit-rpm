...
A Dockerfile to build [luajit](http://luajit.org/) RPM for CentOS 6 using [Mock](https://fedoraproject.org/wiki/Mock) or [fedora copr](https://copr.fedoraproject.org/).
